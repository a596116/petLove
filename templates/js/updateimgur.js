...
(function (root, factory) {
    ...
    Imgur.prototype = {
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: 'https://upload.cc/i1/2021/04/10/5VAe6m.png'});
...
var feedback = function(res) {
    ...
    if (res.success === true) {
        ...
        document.getElementById("petphoto").src = get_link;
    }
};

new Imgur({
    clientid: '58f833835585c10', //You can change this ClientID
    callback: feedback
});